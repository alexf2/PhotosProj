...
<asp:Content ID="idAboutContent" ContentPlaceHolderID="idMainContent" runat="server">
    ...
    <article class="Centering ContentLnk">
        ...
        <section class="SectionBody">                        
            <uc:CatItem Path="Spring2026/KamenskoeErshovoOak" NewGal="true" Name="KamenskoeErshovoOak" Description="Ершовский водопад весной, 2026" runat="server" />
            <uc:CatItem Path="Spring2026/NiogaraKaluzskaya" NewGal="true" Name="NiogaraKaluzskaya" Description="Калужская Ниогара весной, 2026" runat="server" />
