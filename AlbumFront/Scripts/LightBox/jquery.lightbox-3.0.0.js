...
;(function($, window, document, undefined)
{
  ...
  $.extend({
    LightBoxObject: {
      ...
      addevents: function()
      {
        ...
        $win.on('resize', this.proxy(function()
        {
        ...
        $win.on('scroll', this.proxy(function()
        {
        ...
        $(document).on('keydown', this.proxy(function(e)
        {
          if (this.visible)
          {
        ...
        this.esqueleto.buttons.close.on('click touchend', {"fn": "close"}, this.proxy(this.fn));

        this.esqueleto.buttons.max.on('click touchend', {"fn": "maximinimize"}, this.proxy(this.fn));
        
        // heredamos los eventos, desde el overlay:
        this.overlay.element.on('show', this.proxy(function()
        {
          $(this).triggerHandler('show');
        }));
        
        this.overlay.element.on('hide', this.proxy(function()
        {
      ...
      create_gallery: function(collection, options)
      {
        ...
        if (collection.length > 1)
        {
          ...
          $prev.on('click.lightbox touchend.lightbox', function (e)
          {
            e.preventDefault();
          ...
          $next.on('click.lightbox touchend.lightbox', function (e)
          {
            e.preventDefault();
        ...
        $.each(buttons, this.proxy(function(i, button)
          {
            ...
            $a.on('click', this.proxy(function (e)
              {
      ...
      show: function(collection, options, callback)
      {
        ...
        if (type === 'image')
        {
          ...
          $(esqueleto.image).on('load', this.proxy(function()
            {
        ...
        else if (type=='jwplayer' && typeof jwplayer !== "undefined")
        {
          ...
          this.esqueleto.background.on('complete', this.proxy(function()
          {
            this.esqueleto.background.off('complete');
      ...
      loadimage: function()
      {
        ...
        /*background.on('complete', this.proxy(function()
          {
            background.off('complete');*/
      ...
      appendhtml: function(obj, width, height, mode)
      {
        ...
        background.on('complete', function()
        {
      ...
      resize: function(x, y)
      {
        ...
        if (this.visible)
        {
          ...
          if (esqueleto.background.width() == x && esqueleto.background.height() == y)
      ...
      close: function(param)
      {
        ...
        esqueleto.background.stop(true, false).off("complete");
      },
      ...
      getOptions: function(el)
      {
        ...
        return $.extend({}, {
            ...
            element : el[0]
          }, (JSON.parse((el.attr("data-options") || "{}").replace(/\'/g, '"')) || {})
        );
      },
  ...
  $.fn.lightbox = function(options, callback)
  {
    ...
    return this.on('click', function(e)
    {
      ...
      return $.LightBoxObject.link(e, $.extend({}, args, {"element": this}));
    });
