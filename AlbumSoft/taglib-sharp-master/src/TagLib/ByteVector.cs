...
#region Conversions
		...
		{
            /*byte[] d = Data;
            IsTextUnicodeFlags fl = 0;
            bool res = IsTextUnicode(d, d.Length, ref fl);*/

            if (UseBrokenLatin1Behavior)
            {
                string tmp = ToString(StringType.Latin1);
                if (tmp != null && tmp.StartsWith("<?xpacket"))
        ...
        /*[System.Runtime.InteropServices.DllImport("Advapi32", SetLastError = false)]
